...
# 显示K/D信息
execute as @a[scores={datapack.playerkillplayer.title_actionbar=0}] run title @s actionbar ["",{"score":{"name":"@s","objective":"datapack.playerkillplayer.kill"},"bold":true,"color":"aqua"},{"text":" | ","color":"gray"},{"score":{"name":"@s","objective":"datapack.playerkillplayer.dies"},"bold":true,"color":"red"}]
